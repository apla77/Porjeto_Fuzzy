...
namespace TanqueTeste01
{
    public partial class Form1 : Form
    {
        ...
        private void serialPort1_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            if (requested)
            {                
                RxString = (string)serialPort1.ReadExisting();              //ler o dado disponível na serial   
        ...
        private void trataDadoRecebido(object sender, EventArgs e)
        {
            ...
            if (firstClose > firstOpen)
            {
                ...
                //  string sensorFormatado = String.Format("{0:0.###}", relacaoNivel);
        ...
        private void plotar()
        {
            double num = Double.Parse(RxString);
        ...
        private void btnBomba_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                ...
                if (hScrollBarBomba.Value != 0)

                    bombValue = hScrollBarBomba.Value.ToString();

                serialPort1.Write(bombValue);
